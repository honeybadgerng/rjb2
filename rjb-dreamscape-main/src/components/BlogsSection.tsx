  ...
  const blogPosts: BlogPost[] = [
    {
      ...
      excerpt:
        "Explore how blockchain technology is revolutionizing traditional business models and creating new opportunities.",
      date: "May 15, 2023",
      category: "Web3",
      url: "#",
    },
    {
      ...
      excerpt:
        "Discover the top AI-powered tools that are helping businesses streamline operations and boost productivity.",
      date: "June 22, 2023",
      category: "AI",
      url: "#",
    },
    {
      ...
      excerpt:
        "Stay ahead of the curve with these emerging trends in mobile application development and user experience design.",
      date: "July 8, 2023",
    ...
    >
      <div className="max-w-3xl mx-auto mb-12 text-center">
        ...
        <p className="text-lg text-muted-foreground">
          Insights, tips, and industry news from our experts to help you stay

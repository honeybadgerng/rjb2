      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl mx-auto mb-12 text-center">
          ...
          <p className="text-lg text-muted-foreground text-justify">
            ...
            celebrated, and every individual has the tools to thrive. Our dream
            is to build a legacy of empowerment that transcends generations,
            honouring our ancestors while paving the way for future leaders.
          </p>
          <br />
          <h3 className="text-2xl font-bold mb-4 font-mokoto">
            🔥 What Inspires Us
          ...
          <p className="text-lg text-muted-foreground text-justify">
            ...
            belief that every individual has a unique purpose. Our commitment to
            social justice, cultural preservation, and technological innovation
            is not just a mission; it’s a calling.
          </p>
          <br />
          <p className="text-lg text-muted-foreground text-justify">

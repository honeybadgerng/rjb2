  ...
  return (
    <>
      ...
      <section className="dark:bg-gray-900 py-16 px-6 max-w-5xl mx-auto text-gray-800 dark:text-gray-100">
        ...
        <div className="mb-12">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full table-auto text-left border    ">
              ...
              <tbody className="">
                {[
                  ["Prefab Modular Building & Setup", "$15,000", "₦22,500,000"],
                  ["Solar & Internet Infrastructure", "$5,000", "₦7,500,000"],
                  [
                    "Educational Equipment (Laptops etc)",
                    "$6,000",
                    "₦9,000,000",
                  ],
                  ["Curriculum Dev. & Translation", "$7,000", "₦10,500,000"],
                  ["Training, Staffing & Honorariums", "$5,000", "₦7,500,000"],
                  ["Community Outreach & Operations", "$3,000", "₦4,500,000"],
                ].map(([item, usd, naira], index) => (
                  <tr key={index}>
                    <td className="px-4 py-2 border">{item}</td>
                    <td className="px-4 py-2 border">{usd}</td>
                    <td className="px-4 py-2 border">{naira}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        {/* Join Us CTA */}
        <div className="text-center bg-indigo-600 text-white rounded-lg p-8 shadow-md">
